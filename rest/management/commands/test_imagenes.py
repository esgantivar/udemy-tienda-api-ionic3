...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for item in data:
            item.get("fields")["imagen"] = f'productos/{item.get("fields").get("codigo")}.jpg'
